...
const WizardForm = () => {
  ...
  const PersonalForm = (props) => {
      ...
      const [formData, setFormData] = useState({
          firstName: overAllForm.firstName ? overAllForm.firstName : "",
          lastName: overAllForm.lastName ? overAllForm.lastName : "",
          email: overAllForm.email ? overAllForm.email : "",
          phone: overAllForm.phone ? overAllForm.phone : "",
          city: overAllForm.city ? overAllForm.city : "",
      });
        ...
        <Head title="Wizard Form" />
            <Content page="component">
                <BlockHead size="lg" wide="sm">
                    <BlockHeadContent>
                        <BlockTitle tag="h2" className="fw-normal">Wizard Form</BlockTitle>
                    </BlockHeadContent>
                </BlockHead>
