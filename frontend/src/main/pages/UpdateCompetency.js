...
import CompetencyTable from './Tables/CompetencyTable'
                    ...
                    <Card className="card-bordered card-preview">
                        <Content>
                            ...
                            <Block size="xl">
                                ...
                                <PreviewCard>
                                    {$competencies && <CompetencyTable data={$competencies} updateParent={updateParentState} expandableRows pagination actions />}
                                </PreviewCard>
                            </Block>
