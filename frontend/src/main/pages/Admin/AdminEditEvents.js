                                                ...
                                                <Col md='12'>
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-wrap">
                                                            <input type="text" id="name" className="form-control" {...register('name', { required: "This Field is required" })} defaultValue={$event.name} />
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-wrap">
                                                            <textarea id="description" className="form-control" {...register('description', { required: "This Field is required" })} defaultValue={$event.description} ></textarea>
