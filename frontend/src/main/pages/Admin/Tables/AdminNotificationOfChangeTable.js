...
import { loadMegNotificationOfChange, megSendCommentNotificationOfChange } from "redux/stores/notificationOfChange/changeStore";
        ...
        <ModalBody className="modal-body-xl">
          ...
          <div className="nk-modal">
            ...
            <div className="float-end">
              {authUser.is_admin_meg() && complaint.isArApproved ? <>
