...
const ArCreationRequestTable = ({ data, pagination, actions, className, selectableRows, expandableRows }) => {
...
export default ArCreationRequestTable;
