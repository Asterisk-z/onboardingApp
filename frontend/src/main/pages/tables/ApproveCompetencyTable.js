                        ...
                        <CardBody className="card-inner">
                            ...
                            <table className="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Name </td>
                                        <td className="text-capitalize">{`${tabItem?.framework.name}`}</td>
                                    </tr>
                                    <tr>
                                        <td>Description </td>
                                        <td className="text-capitalize">{`${tabItem?.framework.description}`}</td>
                                    </tr>
                                    <tr>
                                        <td>AR </td>
                                        <td className="text-capitalize"><p>{`${tabItem.ar.first_name} ${tabItem.ar.last_name}`}<br />{`${tabItem.ar.email}`}</p></td>
                                    </tr>
                                    <tr>
                                        <td>Status</td>
...
const ApproveCompetencyTable = ({ data, pagination, actions, className, selectableRows, expandableRows, updateParent }) => {
    ...
    const ApproveCompetencyColumn = [
        ...
        {
            name: "Evidence",
            selector: (row) => { return row.evidence ? (<><a href={row.evidence_file} target="_blank" className="btn btn-secondary btn-xs">View</a></>) : "" },
            sortable: true,
            width: "150px",
        },
        {
