...
const PasswordChange = () => {
  ...
  const [arEmail, setArEmail] = useState(localStorage.getItem('reset-password-email') ?? searchParams.get('email'));
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
              <div className="form-group">
                ...
                <div className="form-control-wrap">
                  <input type="email"  {...register('email', { required: "This field is required" })} readOnly={true} value={arEmail} className="form-control form-control-lg" placeholder="Enter your email address" autoComplete="off" />
