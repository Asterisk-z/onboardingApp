...
class CreateARTransferRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('a_r_transfer_requests', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('update_payload');
            $table->integer('new_institution_id')->nullable();
    ...
    {
        Schema::dropIfExists('a_r_transfer_requests');
    }
}
