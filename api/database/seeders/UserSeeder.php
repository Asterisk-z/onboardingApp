...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $roles = ['chidiebere.enibe@fmdqgroup.com', 'oyime.ibitoye@fmdqgroup.com', 'adeoluwa.owolabi@fmdqgroup.com', 'rafiqat.abaniwonda@fmdqgroup.com', 'elizabeth.lamina@fmdqgroup.com'];
        // $roleId = ['2', '3', '4', '8', '1'];
