    ...
    public function run()
    {
        ...
        $fields = [
            ...
            [
                ...
                "description" => 'Particulars of Directors – CAC Form 7, CAC Form 1.1 or Status Report',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
            [
                ...
                "description" => 'Particulars of Shareholders – CAC form 2 or Status Report  [for Private Companies (Ltd.) only]',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
            [
                ...
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as an FMDQ Dealer [if applicable] ',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
            [
                "category" => '1',
                "name" => 'evidenceOfRenewal',
                "description" => 'Evidence Renewal Of SEC registration as  an FMDQ Dealer (if applicable)',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
            ...
            [
                ...
                "description" => 'Latest Fidelity Bond [where applicable]',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
        ...
        $fields = [
            ...
            [
                "category" => '2',
                "name" => 'evidenceOfRegistration',
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as a Broker/Dealer or Dealer', // Can be deferred
                // "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as a Broker/Dealer or Dealer [if applicable] ',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
            [
                "category" => '2',
                "name" => 'evidenceOfRenewal',
                "description" => 'Evidence Renewal Of SEC registration as a Broker/Dealer or Dealer (if applicable)',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
        ...
        $fields = [
            ...
            [
                "category" => '3',
                "name" => 'evidenceOfRegistration',
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as a  Dealer or Broker/Dealer  ',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
            [
                "category" => '3',
                "name" => 'evidenceOfRenewal',
                "description" => 'Evidence Renewal Of SEC registration as a  Dealer or Broker/Dealer (if applicable)',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
            ...
            [
                ...
                "description" => 'Evidence of minimum shareholders’ funds of ₦500,000,000.00 (Five Hundred Million Naira) only	',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
        ...
        $fields = [
            ...
            [
                "category" => '4',
                "name" => 'evidenceOfRegistration',
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as an inter-dealer Broker',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
            [
                "category" => '4',
                "name" => 'evidenceOfRenewal',
                "description" => 'Evidence Renewal Of SEC registration as an inter-dealer Broker (if applicable)',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
        ...
        $fields = [
            ...
            [
                "category" => '6',
                "name" => 'evidenceOfRegistration',
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria as an issuing house ',
                "type" => 'file',
                "required" => 1,
                "page" => '4',
            ],
            [
                "category" => '6',
                "name" => 'evidenceOfRenewal',
                "description" => 'Evidence Renewal Of SEC registration as an issuing house (if applicable)',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
...
//Registration Member (Quotations) CATEGORY
        ...
        $fields = [
            ...
            [
                "category" => '7',
                "name" => 'evidenceOfRegistration',
                "description" => 'Evidence of registration with the Securities and Exchange Commission (SEC), Nigeria [if applicable]',
                "type" => 'file',
                "required" => 0,
                "page" => '4',
            ],
