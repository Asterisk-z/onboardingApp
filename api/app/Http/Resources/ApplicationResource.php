    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "basic_details" => [
                ...
                'individualModeOfIdentification' => $this->individualModeOfIdentification,
                'individualResidentialAddress' => $this->individualResidentialAddress,
                ...
                'reasonForSeekingMembership' => $this->reasonForSeekingMembership,
            ],
            ...
            "supporting_document" => [
                ...
                'modeOfIdentification' => $this->modeOfIdentification ? config('app.url') . '/storage/' . $this->modeOfIdentification : null,
