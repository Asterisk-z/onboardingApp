    ...
    <div class="page" contenteditable="false">
        <section class="page-one">
            ...
            <div class="pageNo-DocName" style="margin-top: 95px;">
                ...
                <div class="DocName" style="font-size: 13px;">FMDQ Exchange Membership Agreement for Associate Member (Inter-Dealer Brokers)</div>
            </div>
        </section>
    </div>
    <div class="page" contenteditable="false">
                        ...
                        <div class="content table-of-content">
                            ...
                            <div style="width: 100%; font-size: 15px;">
                                <ol style="margin-left: 20px;">
                                    ...
                                    <li>
                                        <div class="toc-item">Confidentiality<span>..........................................................................................................................................</span>18
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <div>
                                    ...
                                    <div class="sub-dictionary ">
                                        ...
                                        <p class="definition">means any information, communication or data, about any of
                                            ...
                                            activities, marketing, financial research or development activities,
                                            databases, Intellectual Property Rights, the terms and conditions of this
                                            Agreement and other information in relation to it, whether or not it is
                                            specifically marked confidential but excluding any information, which:</p>
                                    </div><br>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="content" style="text-align: justify;">
                            <div class="dictionary ml-40">
                                ...
                                <div>
                                    <div class="sub-dictionary ">
                                        <p class="term"><strong> </strong></p>
                                        <p class="definition">the ability of a Party to perform its obligations or
                                    ...
                                    <div class="sub-dictionary ">
                                        ...
                                        <p class="definition">means an Associate Member (Inter-Dealer Broker), which is
                                            ...
                                            administrators, fund managers and insurance companies. These institutions
                                            are registered by the Securities and Exchange Commission as inter-dealer
                                            brokers, and are authorised by FMDQ Exchange to provide their services on
                                            the FMDQ Exchange platform;</p>
                                    </div><br>
                                    <!-- <div class="sub-dictionary ">
                                    ...
                                    <div class="sub-dictionary ">
                                        ...
                                        <p class="definition">has the meaning contained in the Nigeria Data Protection,
                                            Act, 2023.</p>
                                    </div><br>
                                    <div class="sub-dictionary ">
                                        ...
                                        <div style="margin-left: 64px;">
                                            ...
                                            <div style="display: flex; margin-bottom: 20px;">
                                                ...
                                                <p style="width: 90%; margin-top: 0;">
                                                    ...
                                                    Exchange after the execution of this Agreement, specifying the name
                                                    and principal place of business of the other Securities Exchange,
                                                    the date it was registered as a member of the Securities Exchange,
                                                    the duration of its membership, and such additional or other
                                                    information as may be required by FMDQ Exchange;
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div><b>5 <span style="margin-left: 27px;">Anti-Money Laundering</span></b><br><br>
                                        <div style="margin-left: 40px;">
                                            <div style="display: flex; margin-bottom: 20px;">
                                                ...
                                                <p style="width: 90%; margin-top: 0;">
                                                    The Member covenants and always represents that during the
                                                    subsistence of this Agreement, it shall comply with all applicable
                                                    laws, policies and regulations on money laundering including the SEC
                                                    (Capital Market Operators Anti-Money Laundering, Combating the
                                                    Financing of Terrorism and Proliferation Financing), Regulations,
                                                    2022 and shall establish/maintain a robust and comprehensive
                                                    anti-money laundering/counter-terrorism financing framework. It
                                                    shall adopt policies stating its commitment to comply with
                                                    Anti-Money Laundering, Countering the Financing of Terrorism and
                                                    Countering the Proliferation Financing (“AML/CFT/CPF”) obligations
                                                    under the law and regulatory directives to actively prevent any
                                                    transaction that facilitates criminal activities.
                                                </p>
                                            </div>
                                            <div style="display: flex; margin-bottom: 20px;">
                                                <p style="width: 10%;">5.2</p>
                                                <p style="width: 90%; margin-top: 0;">
                                                    The Member undertakes to keep all records and documentation pertaining to
                                                    any anti-money laundering and counter-terrorism financing due diligence
                                                    procedures relating to its activities on the Platform for such period as
                                                    required by FMDQ Exchange or by Applicable Law.
                                                </p>
                                            </div>
                                            <div style="display: flex; margin-bottom: 20px;">
                                                <p style="width: 10%;">5.3</p>
                                                <p style="width: 90%; margin-top: 0;">
                                                    Subject to any Applicable Law prohibiting disclosure, if FMDQ Exchange is
                                                    required by the regulatory authorities, to satisfy itself or such
                                                    authorities as to the facts of any transaction or activities of the Member
                                                    on the Platform or FMDQ Exchange suspects any form of money laundering or
                                                    terrorism financing, or at any time pursuant to FMDQ Exchange’s request, the
                                                    Member must immediately provide copies of all due diligence materials
                                                    relating to such transaction or activities to FMDQ Exchange and/or all
                                                    relevant regulatory authorities. In such circumstances, the Member must also
                                                    provide a translation and certification of such documents if so requested by
                                                    FMDQ Exchange
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            ...
                                            <p style="width: 90%; margin-top: 0;">
                                                If the Member delegates, assigns, subcontracts or transfers any of its
                                                rights or obligations under this Agreement to another party, the Member
                                                shall ensure that such party complies with the requirements set out in this
                                                Agreement, FMDQ Exchange Rules and Applicable Law.
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">5.5</p>
                                            <p style="width: 90%; margin-top: 0;">
                                                The Member will ensure that none of its subsidiaries or Affiliates will fund
                                                all or part of any payment under any transaction out of proceeds derived
                                                from any unlawful activity which would result in any violation of any
                                                anti-money laundering or counter-terrorism financing legislation in force in
                                                Nigeria (as may be amended) and regulations thereunder or any other
                                                Applicable Law or regulation concerning anti-money laundering or the
                                                prevention thereof.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div><b>6 <span style="margin-left: 27px;">Examination of Documents</span></b><br><br>
                                    ...
                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            ...
                                            <p style="width: 90%; margin-top: 0;">
                                                The Member hereby undertakes that it shall make itself available for
                                                examination or audit howsoever required, and to make available any document
                                                or record relating to the Member’s functions as a Member, whether by means
                                                of paper copy, electronic copy, disk, hard drive, flash drive or such other
                                                storage device in its possession or subject to its possession, when required
                                                by FMDQ Exchange to carry out its supervisory function, provided that FMDQ
                                                Exchange shall give notice of such examination or review. Notwithstanding
                                                the foregoing, the Parties agree that FMDQ Exchange shall have the right to
                                                audit the documents or records of the Member, at any time and without
                                                notice, where there is a reasonable cause to do so.
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">6.2</p>
                                            <p style="width: 90%; margin-top: 0;">
                                                FMDQ Exchange shall ensure the confidentiality of documents provided under
                                                Clause 6.1 above and not to disclose its content except as required by any
                                                law, rule, regulation, order, and judgment of a competent court in Nigeria
                                                or for any other lawful purpose and shall notify the Member before such
                                                disclosure where practicable, and where it is impracticable to notify the
                                                Member prior to such disclosure, provide written notice to the Member
                                    ...
                                    <div style="margin-left: 40px;">
                                        ...
                                        <div style="margin-left: 64px;">
                                            ...
                                            <div style="display: flex; margin-bottom: 20px;">
                                                ...
                                                <p style="width: 90%; margin-top: 0;">
                                                    Notice of the revised membership dues shall be communicated to the
                                                    Member within seven (7) Business Days of such revision and in any
                                                    case before the expiration of the subsisting membership dues.
                                                </p>
                                            </div>
                                        ...
                                        <div style="margin-left: 0px;">
                                            <div style="display: flex">
                                                ...
                                                <p style="width: 90%; margin-top: 0">For the purpose of this clause,
                                                    “disclose” means to alert, make known or reveal any of the event
                                                    mentioned in clause 4.1 to FMDQ Exchange. FMDQ Exchange however
                                                    reserves the right to demand more information should the need arise.
                                                </p>
                                            </div><br>
                                ...
                                <div>
                                    ...
                                    <div style="margin-left: 40px;">
                                        <div style="display: flex">
                                            ...
                                            <p style="width: 90%; margin-top: 0"><b>Authorised Representatives of the Member</b></p>
                                        </div><br>
                                        <div style="margin-left: 64px;">
                                            <div style="display: flex; margin-bottom: 20px;">
                                            ...
                                            <div style="display: flex; margin-bottom: 20px;">
                                                ...
                                                <p style="width: 90%; margin-top: 0;">
                                                    The Member shall have the responsibility and duty to ascertain the character, business repute, qualifications and experience of its Authorised Representatives
                                                </p>
                                            </div>
                                            <div style="display: flex; margin-bottom: 20px;">
                                                <p style="width: 10%;">9.3.8</p>
                                                <p style="width: 90%; margin-top: 0;">
                                                    The Member shall also be responsible for ensuring that training programmes are designed to enhance the knowledge and competence of its Authorised Representatives as an Associate Member (Inter-Dealer Broker) of FMDQ Exchange
                                                </p>
                                            </div>
                                            <div style="display: flex; margin-bottom: 20px;">
                                ...
                                <div><b>10 <span style="margin-left: 21px;">Member’s Obligations</span></b><br><br>
                                    ...
                                    <div style="margin-left: 40px;">
                                        ...
                                        <div style="display: flex; margin-bottom: 20px;">
                                            ...
                                            <p style="width: 90%; margin-top: 0;">
                                                notify FMDQ Exchange immediately in writing of any material changes to the information submitted during the course of its membership application, including in particular (but not limited to) those in respect of the Member's license or permission to conduct trading in Products;
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom: 20px;">
                ...
                <div class="page-border-one">
                    <div class="page-border-two" style="padding-top: 20px;align-items: flex-start;">
                        <div class="content" style="text-align: justify;">
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>11 <span style="margin-left: 21px;">Discipline of the Member</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                                    ...
                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            ...
                                            <p style="width: 90%; margin-top: 0;">
                                                ...
                                                (e) &nbsp Public and/or Private Censure
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom: 20px;">
                        ...
                        <div class="content" style="text-align: justify;">
                            <div class="dictionary" style="margin-left: 20px;">
                                <div>
                                    ...
                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">11.3</p>
                                            <p style="width: 90%; margin-top: 0;">
                                                Where the Member’s license is revoked, it shall forthwith lose all rights to act as a Member.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>12 <span style="margin-left: 21px;">Termination of Membership</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>13 <span style="margin-left: 21px;">Reporting Requirements</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                ...
                <div class="page-border-one">
                    <div class="page-border-two" style="padding-top: 20px;align-items: flex-start;">
                        <div class="content" style="text-align: justify;">
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>14 <span style="margin-left: 21px;">Willingness to Promote FMDQ Exchange</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>15 <span style="margin-left: 21px;">Confidentiality and Data Protection</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>16 <span style="margin-left: 21px;">Limitation of Liability</span></b><br><br>
                                    <!-- <p>1.2</p> -->

                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">16.1</p>
                                            <p style="width: 90%; margin-top: 0;">
                ...
                <div class="page-border-one">
                    <div class="page-border-two" style="padding-top: 20px;align-items: flex-start;">
                        <div class="content" style="text-align: justify;">
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>17 <span style="margin-left: 21px;">Indemnity</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>18 <span style="margin-left: 21px;">Notices</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                ...
                <div class="page-border-one">
                    <div class="page-border-two" style="padding-top: 20px;align-items: flex-start;">
                        <div class="content" style="text-align: justify;">
                            <div class="dictionary" style="margin-left: 20px;">
                                <div>
                                    ...
                                    <div style="margin-left: 40px;">
                                        ...
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">18.3</p>
                                            <p style="width: 90%; margin-top: 0;">
                                                In addition to clause 18.1, FMDQ Exchange may convey notices via electronic broadcasts and/or via the Market Bulletin segment on the FMDQ Exchange website.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>19 <span style="margin-left: 27px;">Binding Agreement</span></b><br><br>
                                    <!-- <p>1.2</p> -->

                                    <div style="margin-left: 40px;">
                                        <p>
                                            Notwithstanding any contrary agreement, both Parties agree that this Agreement constitutes a legal, valid and binding agreement which shall be enforceable against either Party in accordance with its terms.
                                        </p>
                                    </div><br>
                                </div>
                            </div>
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>20<span style="margin-left: 27px;">Non-Waiver</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>21<span style="margin-left: 27px;">Severability</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>22<span style="margin-left: 27px;">Governing Law</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>23 <span style="margin-left: 21px;">Dispute Resolution</span></b><br><br>
                                    <!-- <p>1.2</p> -->

                                    <div style="margin-left: 40px;">
                                        <div style="display: flex; margin-bottom: 20px;">
                                            <p style="width: 10%;">23.1</p>
                                            <p style="width: 90%; margin-top: 0;">
            ...
            <div class="page-container">
                <div class="page-border-one">
                    <div class="page-border-two" style="padding-top: 20px;align-items: flex-start;">
                        <div class="content" style="text-align: justify;">
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>24<span style="margin-left: 27px;">Amendment</span></b><br><br>
                                    <!-- <p>1.2</p> -->
                            ...
                            <div class="dictionary" style="margin-left: 20px;">
                                <div><b>25<span style="margin-left: 27px;">Execution of Agreement</span></b><br><br>
                                    <!-- <p>1.2</p> -->

                                    <div style="margin-left: 40px;">
                                        <p>
                                            This Agreement shall be executed on behalf of the Member by any Director (s) or Company Secretary of the Member. Where the Agreement is executed by any other representative of the Member, the Member must notify FMDQ Exchange in writing that such representative is authorised to execute this Agreement.
                                        </p>
                                    </div><br>
                                </div>
                            </div>
