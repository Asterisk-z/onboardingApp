                ...
                <div class="page-border-one">
                    <div class="page-border-two">
                        ...
                        <div class="title-two">
                            ...
                            <p>AFFILIATE MEMBER (STANDARD - INDIVIDUAL) MEMBERSHIP AGREEMENT</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content-page-border-two">
                        ...
                        <div class="content">
                            <div class="content-header" style="text-align: center;"><strong>FMDQ SECURITIES EXCHANGE
                                    LIMITED AFFILIATE MEMBERSHIP (STANDARD - INDIVIDUAL) AGREEMENT (THE
                                    “AGREEMENT”)</strong></div>
                            <p>
                                I <span class="user-input one"></span> (“Affiliate Member”) on this <span class="user-input two"></span> day of <span class="user-input three"></span> 20<span class="user-input four"></span> hereby agree to be an Affiliate Member on FMDQ
                                Securities Exchange Limited (“FMDQ Exchange” or the “Exchange”), a securities exchange
                                organised under the laws of the Federal Republic of Nigeria (together, the “Parties”),
                                subject to the terms and conditions below
                            </p><br>
                            <div class="content-header sub-header"><strong>AS AN AFFILIATE MEMBER OF FMDQ EXCHANGE, I
                            ...
                            <div class="pageNo-DocName">
                                ...
                                <div class="DocName" style="font-size: 13px;"><strong><i>FMDQ Exchange Affiliate Member (Standard-Individual) Membership Agreement</i></strong></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-container">
                <div class="page-border-one">
                    <div class="content-page-border-two">
                        ...
                        <div class="content">
                            <ol start="11">
                                <li>FMDQ Exchange owns all rights, title and interest to the “e-Markets” Portal and all
                                    intellectual property rights embodied in or associated with the portal, and this
                                    Agreement does not grant the Member any intellectual property rights to the portal
                                    and its contents.</li>
                                ...
                                <li>The Parties will comply with the provisions of the Nigeria Data Protection
                                    Regulation, 2019 issued by the National Information Technology Development Agency
                                    and any amendments thereto in respect of any personal data received pursuant to or
                                    in connection with this Agreement.</li>
                                <li>The Member agrees to hold harmless and indemnify FMDQ Exchange, its affiliates,
                                    officers, agents, and employees, from and against any loss, damages or claim arising
                                    from the Member’s breach of the terms of this Agreement.</li>
                                <li>Notwithstanding any other agreement to the contrary, this Agreement and all
                                    amendments thereto shall be governed by and construed in accordance with the laws of
                                    the Federal Republic of Nigeria</li>
                            </ol><br>
            ...
            <div class="page-container">
                <div class="page-border-one">
                    <div class="content-page-border-two">
                        ...
                        <div class="content">
                            <div>
                                <div style="text-decoration: underline;"><strong><i>Individual:</i></strong></div>
