            ...
            <table class="p2Table">
                ...
                <tr>
                    <td class="padding-20 background">
                        ...
                        <ol type="A" style="margin-left: 20px;">
                            <li>FMDQ Exchange is licensed by the SEC as a securities exchange and self-regulatory organisation with a Platform (as defined below) to enable its Members deal in Securities (as defined below) and carry out other activities.</li><br>
                            ...
                            <li>The Member has agreed to be duly licensed by FMDQ Exchange as a Registration Member (Listings). </li><br>
                ...
                <tr>
                    <td class=" padding-20 agreedTerm" style="">
                        ...
                        <ol type="A" style="margin-left: 20px;">
                            <li>
                                In this Agreement, unless the context otherwise requires, the following expressions shall have the meanings set out hereunder:-<br><br>
                                <table>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 350px; vertical-align: top;">
                                                means Registration Members (Listings), which is a financial institution (CBN-licenced deposit money bank or discount house, or non-bank financial institution sponsoring the listing of Issuers’ Securities on the Platform;
                                            </td>
                                        </tr>
                            ...
                            <li>
                                ...
                                <span>1.2.1 Words importing the singular number only shall include the plural and vice-versa and words importing the feminine gender only shall include the masculine gender and vice versa and words importing persons shall include corporations, associations, partnerships and governments (whether state or local), and the words “written” or “in writing” shall include printing, engraving, lithography or other means of visible reproduction.</span>
                                <br><br>
                                <span>1.2.2 The words “hereof,” “herein,” “hereby,” “hereto” and similar words refer to this entire Agreement and not any particular Clause, Schedule or other subdivision of this Agreement.</span>
                                <br><br>
                                <span>1.2.3 A reference to “Party” or “Parties” shall mean a party or parties to this Agreement.</span>
                                <br><br>
                                <span>1.2.4 A reference to a statutory provision shall be deemed to include that provision as the same may from time to time be modified, amended or re-enacted.</span>
                                <div class="page-break"></div>
                                <br>
                                <br>

                                <span>1.2.5 Any reference to Clauses and Schedules, are to Clauses and Schedules of this Agreement, and references to sub-clauses and paragraphs are references to sub-clauses and paragraphs of the clause or schedule in which they appear.</span>
                                <br><br>
                                <span>1.2.6 A reference to a provision of this Agreement is to that provision as amended in accordance with the terms of this Agreement.</span>
                                <br><br>
                                <span>1.2.7 A reference to “consent” means any consent, approval, authorisation, licence or clearance of any kind whether fiscal, statutory or regulatory.</span>
                                <br><br>
                                <span>1.2.8 A reference to any document being “in the agreed form” means in a form which has been agreed by the Parties on or before the date of this Agreement and for identification purposes signed by them or on their behalf by their authorised signatories.</span>
                                <br><br>
                                <span>1.2.9 References to days shall refer to calendar days unless Business Days are specified; references to weeks, months or years shall be to calendar weeks, months or years respectively.</span>
                                <br><br>
                                <span>1.2.10 References to any liability shall include actual, contingent, present or future liabilities.</span>
                                <br><br>
                                <span>1.2.11 Words and expressions defined in any clause shall, unless the application of any such word or expression is specifically limited to that clause, bear the meaning assigned to such word or expression throughout this Agreement.</span>
                                <br><br>
                                <span>1.2.12 The expiration or termination of this Agreement shall not affect the provisions of this Agreement which are expressly indicated to survive the expiration or termination or which of necessity must continue to have effect after such expiration or termination either expressly or impliedly.</span>
                                <br><br>
                                <span>1.2.13 Where figures are referred to in numerals and in words, and there is any conflict between the two, the words shall prevail, unless the context indicates a contrary intention.</span>
                                <br><br>
                                <span>1.2.14 Defined terms appearing in this Agreement in upper case shall be given their meaning as defined, while the same terms appearing in lower case shall be interpreted in accordance with their plain English meaning.</span>
                                <br><br>
                                <span>1.2.15 Words and phrases used in this Agreement, unless otherwise defined in this Agreement, shall have the meanings given to them in the FMDQ Exchange Rules, SEC Rules, CBN circulars, DMO guidelines, the ISA and any other legislative enactment.</span>
                                <br><br>
                                <span>1.2.16 A reference to FMDQ Exchange or the Member herein shall include reference to their respective successors and assigns.</span>
                                <br><br>
                                <span>1.2.17 The division of this Agreement into clauses and sub-clauses, the provision of a table of contents and the insertion of headings are for convenience of reference only and shall not be deemed to form part of the text or affect the construction or interpretation hereof.</span>
                                <br><br>
                                <span>1.2.18 Any money payable under this Agreement on a day that falls on a public holiday shall be paid on the next Business Day.</span>
                                <br><br>
                                <div class="page-break"></div>
                                <br>
                                <br>
                ...
                <tr>
                    <td class="padding-20 background">
                        ...
                        <ol type="A" style="margin-left: 20px;">
                            <li>FMDQ Exchange is licensed by the SEC as a securities exchange and self-regulatory organisation with a Platform (as defined below) to enable its Members deal in Securities (as defined below) and carry out other activities.</li><br>
                            <li>{{ $details->name }} the Member is a financial institution licensed by the SEC and has indicated interest in becoming a Member (as defined below) of FMDQ Exchange with a view to acting as a sponsor to Issuers’ listing of Securities on the Platform. </li><br>
                            <li>The Member has agreed to be duly licensed by FMDQ Exchange as a Registration Member (Quotation). </li><br>
                            <li> Pursuant to the foregoing, the Parties hereby agree to be bound by the terms herein contained.</li>
                        </ol>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 200px !important; vertical-align: top;"><strong>“ Member ”</strong></td>
                                            <td style="width: 350px; vertical-align: top;">
                                                means Registration Members (Quotation), which is a financial institution (CBN-licenced deposit money bank or discount house, or non-bank financial institution sponsoring the listing of Issuers’ Securities on the Platform;
                                            </td>
                                        </tr>
