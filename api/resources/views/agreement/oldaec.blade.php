            ...
            <div class="page-container">
                <div class="page-border-one">
                    <div class="page-border-two">
                        <img src="{{ asset('assets/img/FMDQ-Logo2.svg') }}" alt="logo">
                        <div class="title">
            ...
            <div class="page-container">
                <div class="page-border-one">
                    <div class="content-page-border-two">
                        <div class="top-logo">
                            <img src="assets/img/FMDQ-Logo4.svg" alt="small-logo">
                        </div>
                        <div class="content">
        ...
        <section class="page-three">
            <div class="page-container">
                <div class="page-border-one">
                    <div class="content-page-border-two">
                        <div class="top-logo">
                            <img src="{{ asset('assets/img/FMDQ-Logo4.svg') }}" alt="small-logo">
                        </div><br>
                        <div class="content">
                            <ol start="11">
